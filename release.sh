...
then
  ...
  wget https://oplab9.parqtec.unicamp.br/pub/ppc64el/grafana/grafana-7.1.5-cli
  wget https://oplab9.parqtec.unicamp.br/pub/ppc64el/grafana/grafana-7.1.5-server
